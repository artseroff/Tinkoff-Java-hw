...
public class LogAnalyser {
    ...
    public LogAnalyser(Configuration config, LogsData logsData) throws IOException {
     ...
     * час, среднее количество запросов в этот час,
     * процентное значение количества запросов от общего количества
     */
    @SuppressWarnings("MagicNumber")
